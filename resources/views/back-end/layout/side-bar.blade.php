<section id="left-navigation">
    ...
    <div class="user-image">
        <img class='img-responsive'
            ...
            src="{{asset('panel/assets/images/demo/avatar-80.png')}}"
    ...
    <ul class="mainNav">
        ...
        @if( Auth::user()->role == 1 || Auth::user()->role == 2 )
        <li>
            <a id="orders" href="{{route('clients.index')}}" class="{{is_active('clients')}}">
                <i class="fa fa-group"></i><span>التجار</span>
        ...
        <li> 
            <a id="bills" href="{{url('admin/expenses?month='.date("m").'&limit=500')}}" class="{{is_active('expenses')}}">
                <i class="fas fa-pencil-square-o"></i><span>المصروفات</span>
            </a>
        </li>
        <li>
